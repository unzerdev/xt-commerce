...
class cw_UNZ_directdebitssepa extends UnzerCw_AbstractPaymentMethod
{
	private $paymentMethodName = 'directdebitssepa';
	private $defaultDisplayName = 'Sepa Direct Debits';
	private static $settingsDefintions = array(
		'status_authorized' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_STATUS_AUTHORIZED',
 			'default' => 'authorized',
 		),
 		'status_uncertain' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_STATUS_UNCERTAIN',
 			'default' => 'uncertain',
 		),
 		'status_cancelled' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_STATUS_CANCELLED',
 			'options' => array(
 		...
 		'status_captured' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_STATUS_CAPTURED',
 			'options' => array(
				'no_status_change' => 'Don\'t change order status',
 			),
 		...
 		'placeholder_size' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_PLACEHOLDER_SIZE',
 			'options' => array(
 		...
 		'send_basket' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_SEND_BASKET',
 			'options' => array(
				'no' => 'Do not send',
 				'yes' => 'Send Basket',
 			),
 		...
 		'send_customer' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_SEND_CUSTOMER',
 			'options' => array(
				'no' => 'Do not send',
 				'yes' => 'Send Customer',
 			),
 		...
 		'merchant_name' => array(
			'type' => 'TEXTFIELD',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_MERCHANT_NAME',
 			'default' => '',
 		),
 		'authorizationmethod' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_AUTHORIZATIONMETHOD',
 			'options' => array(
 		...
 		'allow_alias_opt_out' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_ALLOW_ALIAS_OPT_OUT',
 			'options' => array(
				'yes' => 'Yes',
 				'no' => 'No',
 			),
 		...
 		'payment_form_position' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_DIRECTDEBITSSEPA_PAYMENT_FORM_POSITION',
 			'options' => array(
	...
	private static $installSettings = array(
			'UNZERCW_DIRECTDEBITSSEPA_STATUS_AUTHORIZED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_STATUS_AUTHORIZED',
 				'value' => 'authorized',
 				'url' => 'unzercw_directdebitssepa___status_authorized:order_status',
 				'de' => array(
 			...
 			'UNZERCW_DIRECTDEBITSSEPA_STATUS_UNCERTAIN' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_STATUS_UNCERTAIN',
 				'value' => 'uncertain',
 				'url' => 'unzercw_directdebitssepa___status_uncertain:order_status',
 				'de' => array(
 			...
 			'UNZERCW_DIRECTDEBITSSEPA_STATUS_CANCELLED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_STATUS_CANCELLED',
 				'value' => 'cancelled',
 				'url' => 'unzercw_directdebitssepa___status_cancelled:order_status',
 				'de' => array(
 			...
 			'UNZERCW_DIRECTDEBITSSEPA_STATUS_CAPTURED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_STATUS_CAPTURED',
 				'value' => 'no_status_change',
 				'url' => 'unzercw_directdebitssepa___status_captured:order_status',
 				'de' => array(
 			...
 			'UNZERCW_DIRECTDEBITSSEPA_PLACEHOLDER_SIZE' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_PLACEHOLDER_SIZE',
 				'value' => 'narrow',
 				'url' => 'unzercw_directdebitssepa___placeholder_size',
 				'de' => array(
 			...
 			'UNZERCW_DIRECTDEBITSSEPA_SEND_BASKET' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_SEND_BASKET',
 				'value' => 'no',
 				'url' => 'unzercw_directdebitssepa___send_basket',
 				'de' => array(
 			...
 			'UNZERCW_DIRECTDEBITSSEPA_SEND_CUSTOMER' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_SEND_CUSTOMER',
 				'value' => 'no',
 				'url' => 'unzercw_directdebitssepa___send_customer',
 				'de' => array(
 			...
 			'UNZERCW_DIRECTDEBITSSEPA_MERCHANT_NAME' => array(
				'type' => 'textfield',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_MERCHANT_NAME',
 				'value' => '',
 				'de' => array(
					'title' => 'Händlername&lt;tooltip&gt;Der Händlername wird angezeigt im Mandatstext, der dem Kunden während dem Zahlungsvorgang angezeigt wird.&lt;/tooltip&gt;',
 				),
 				'en' => array(
					'title' => 'Merchant name&lt;tooltip&gt;Here you can configure the merchant name which is displayed as part of the mandate text.&lt;/tooltip&gt;',
 				),
 				'it' => array(
					'title' => 'Merchant name&lt;tooltip&gt;Here you can configure the merchant name which is displayed as part of the mandate text. &lt;/tooltip&gt;',
 				),
 			...
 			'UNZERCW_DIRECTDEBITSSEPA_AUTHORIZATIONMETHOD' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_AUTHORIZATIONMETHOD',
 				'value' => 'AjaxAuthorization',
 				'url' => 'unzercw_directdebitssepa___authorizationmethod',
 				'de' => array(
 			...
 			'UNZERCW_DIRECTDEBITSSEPA_ALLOW_ALIAS_OPT_OUT' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_ALLOW_ALIAS_OPT_OUT',
 				'value' => 'yes',
 				'url' => 'unzercw_directdebitssepa___allow_alias_opt_out',
 				'de' => array(
 			...
 			'UNZERCW_DIRECTDEBITSSEPA_PAYMENT_FORM_POSITION' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_DIRECTDEBITSSEPA_PAYMENT_FORM_POSITION',
 				'value' => 'confirmation_page',
 				'url' => 'unzercw_directdebitssepa___payment_form_position',
 				'de' => array(
