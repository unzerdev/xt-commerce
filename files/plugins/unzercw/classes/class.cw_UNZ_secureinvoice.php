...
class cw_UNZ_secureinvoice extends UnzerCw_AbstractPaymentMethod
{
	private $paymentMethodName = 'secureinvoice';
	private $defaultDisplayName = 'Secure Invoice';
	private static $settingsDefintions = array(
		'status_authorized' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_SECUREINVOICE_STATUS_AUTHORIZED',
 			'default' => 'authorized',
 		),
 		'status_uncertain' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_SECUREINVOICE_STATUS_UNCERTAIN',
 			'default' => 'uncertain',
 		),
 		'status_cancelled' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_SECUREINVOICE_STATUS_CANCELLED',
 			'options' => array(
 		...
 		'status_captured' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_SECUREINVOICE_STATUS_CAPTURED',
 			'options' => array(
				'no_status_change' => 'Don\'t change order status',
 			),
 		...
 		'authorizationmethod' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_SECUREINVOICE_AUTHORIZATIONMETHOD',
 			'options' => array(
 		...
 		'allow_alias_opt_out' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_SECUREINVOICE_ALLOW_ALIAS_OPT_OUT',
 			'options' => array(
				'yes' => 'Yes',
 				'no' => 'No',
 			),
 		...
 		'payment_form_position' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_SECUREINVOICE_PAYMENT_FORM_POSITION',
 			'options' => array(
	...
	private static $installSettings = array(
			'UNZERCW_SECUREINVOICE_STATUS_AUTHORIZED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECUREINVOICE_STATUS_AUTHORIZED',
 				'value' => 'authorized',
 				'url' => 'unzercw_secureinvoice___status_authorized:order_status',
 				'de' => array(
 			...
 			'UNZERCW_SECUREINVOICE_STATUS_UNCERTAIN' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECUREINVOICE_STATUS_UNCERTAIN',
 				'value' => 'uncertain',
 				'url' => 'unzercw_secureinvoice___status_uncertain:order_status',
 				'de' => array(
 			...
 			'UNZERCW_SECUREINVOICE_STATUS_CANCELLED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECUREINVOICE_STATUS_CANCELLED',
 				'value' => 'cancelled',
 				'url' => 'unzercw_secureinvoice___status_cancelled:order_status',
 				'de' => array(
 			...
 			'UNZERCW_SECUREINVOICE_STATUS_CAPTURED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECUREINVOICE_STATUS_CAPTURED',
 				'value' => 'no_status_change',
 				'url' => 'unzercw_secureinvoice___status_captured:order_status',
 				'de' => array(
 			...
 			'UNZERCW_SECUREINVOICE_AUTHORIZATIONMETHOD' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECUREINVOICE_AUTHORIZATIONMETHOD',
 				'value' => 'AjaxAuthorization',
 				'url' => 'unzercw_secureinvoice___authorizationmethod',
 				'de' => array(
 			...
 			'UNZERCW_SECUREINVOICE_ALLOW_ALIAS_OPT_OUT' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECUREINVOICE_ALLOW_ALIAS_OPT_OUT',
 				'value' => 'yes',
 				'url' => 'unzercw_secureinvoice___allow_alias_opt_out',
 				'de' => array(
 			...
 			'UNZERCW_SECUREINVOICE_PAYMENT_FORM_POSITION' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECUREINVOICE_PAYMENT_FORM_POSITION',
 				'value' => 'confirmation_page',
 				'url' => 'unzercw_secureinvoice___payment_form_position',
 				'de' => array(
