...
class cw_UNZ_securesepa extends UnzerCw_AbstractPaymentMethod
{
	private $paymentMethodName = 'securesepa';
	private $defaultDisplayName = 'Secure SEPA';
	private static $settingsDefintions = array(
		'merchant_name' => array(
			'type' => 'TEXTFIELD',
 			'constant' => 'UNZERCW_SECURESEPA_MERCHANT_NAME',
 			'default' => '',
 		),
 		'status_authorized' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_SECURESEPA_STATUS_AUTHORIZED',
 			'default' => 'authorized',
 		),
 		'status_uncertain' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_SECURESEPA_STATUS_UNCERTAIN',
 			'default' => 'uncertain',
 		),
 		'status_cancelled' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_SECURESEPA_STATUS_CANCELLED',
 			'options' => array(
 		...
 		'status_captured' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_SECURESEPA_STATUS_CAPTURED',
 			'options' => array(
				'no_status_change' => 'Don\'t change order status',
 			),
 		...
 		'placeholder_size' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_SECURESEPA_PLACEHOLDER_SIZE',
 			'options' => array(
 		...
 		'authorizationmethod' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_SECURESEPA_AUTHORIZATIONMETHOD',
 			'options' => array(
 		...
 		'allow_alias_opt_out' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_SECURESEPA_ALLOW_ALIAS_OPT_OUT',
 			'options' => array(
				'yes' => 'Yes',
 				'no' => 'No',
 			),
 		...
 		'payment_form_position' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_SECURESEPA_PAYMENT_FORM_POSITION',
 			'options' => array(
	...
	private static $installSettings = array(
			'UNZERCW_SECURESEPA_MERCHANT_NAME' => array(
				'type' => 'textfield',
 				'key' => 'UNZERCW_SECURESEPA_MERCHANT_NAME',
 				'value' => '',
 				'de' => array(
 			...
 			'UNZERCW_SECURESEPA_STATUS_AUTHORIZED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECURESEPA_STATUS_AUTHORIZED',
 				'value' => 'authorized',
 				'url' => 'unzercw_securesepa___status_authorized:order_status',
 				'de' => array(
 			...
 			'UNZERCW_SECURESEPA_STATUS_UNCERTAIN' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECURESEPA_STATUS_UNCERTAIN',
 				'value' => 'uncertain',
 				'url' => 'unzercw_securesepa___status_uncertain:order_status',
 				'de' => array(
 			...
 			'UNZERCW_SECURESEPA_STATUS_CANCELLED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECURESEPA_STATUS_CANCELLED',
 				'value' => 'cancelled',
 				'url' => 'unzercw_securesepa___status_cancelled:order_status',
 				'de' => array(
 			...
 			'UNZERCW_SECURESEPA_STATUS_CAPTURED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECURESEPA_STATUS_CAPTURED',
 				'value' => 'no_status_change',
 				'url' => 'unzercw_securesepa___status_captured:order_status',
 				'de' => array(
 			...
 			'UNZERCW_SECURESEPA_PLACEHOLDER_SIZE' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECURESEPA_PLACEHOLDER_SIZE',
 				'value' => 'narrow',
 				'url' => 'unzercw_securesepa___placeholder_size',
 				'de' => array(
 			...
 			'UNZERCW_SECURESEPA_AUTHORIZATIONMETHOD' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECURESEPA_AUTHORIZATIONMETHOD',
 				'value' => 'AjaxAuthorization',
 				'url' => 'unzercw_securesepa___authorizationmethod',
 				'de' => array(
 			...
 			'UNZERCW_SECURESEPA_ALLOW_ALIAS_OPT_OUT' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECURESEPA_ALLOW_ALIAS_OPT_OUT',
 				'value' => 'yes',
 				'url' => 'unzercw_securesepa___allow_alias_opt_out',
 				'de' => array(
 			...
 			'UNZERCW_SECURESEPA_PAYMENT_FORM_POSITION' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_SECURESEPA_PAYMENT_FORM_POSITION',
 				'value' => 'confirmation_page',
 				'url' => 'unzercw_securesepa___payment_form_position',
 				'de' => array(
