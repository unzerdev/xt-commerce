...
class cw_UNZ_ideal extends UnzerCw_AbstractPaymentMethod
{
	private $paymentMethodName = 'ideal';
	private $defaultDisplayName = 'iDEAL';
	private static $settingsDefintions = array(
		'status_authorized' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_IDEAL_STATUS_AUTHORIZED',
 			'default' => 'authorized',
 		),
 		'status_uncertain' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_IDEAL_STATUS_UNCERTAIN',
 			'default' => 'uncertain',
 		),
 		'status_cancelled' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_IDEAL_STATUS_CANCELLED',
 			'options' => array(
 		...
 		'status_captured' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_IDEAL_STATUS_CAPTURED',
 			'options' => array(
				'no_status_change' => 'Don\'t change order status',
 			),
 		...
 		'placeholder_size' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_IDEAL_PLACEHOLDER_SIZE',
 			'options' => array(
 		...
 		'send_basket' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_IDEAL_SEND_BASKET',
 			'options' => array(
				'no' => 'Do not send',
 				'yes' => 'Send Basket',
 			),
 		...
 		'send_customer' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_IDEAL_SEND_CUSTOMER',
 			'options' => array(
				'no' => 'Do not send',
 				'yes' => 'Send Customer',
 			),
 		...
 		'authorizationmethod' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_IDEAL_AUTHORIZATIONMETHOD',
 			'options' => array(
 		...
 		'allow_alias_opt_out' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_IDEAL_ALLOW_ALIAS_OPT_OUT',
 			'options' => array(
				'yes' => 'Yes',
 				'no' => 'No',
 			),
 		...
 		'payment_form_position' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_IDEAL_PAYMENT_FORM_POSITION',
 			'options' => array(
	...
	private static $installSettings = array(
			'UNZERCW_IDEAL_STATUS_AUTHORIZED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_IDEAL_STATUS_AUTHORIZED',
 				'value' => 'authorized',
 				'url' => 'unzercw_ideal___status_authorized:order_status',
 				'de' => array(
 			...
 			'UNZERCW_IDEAL_STATUS_UNCERTAIN' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_IDEAL_STATUS_UNCERTAIN',
 				'value' => 'uncertain',
 				'url' => 'unzercw_ideal___status_uncertain:order_status',
 				'de' => array(
 			...
 			'UNZERCW_IDEAL_STATUS_CANCELLED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_IDEAL_STATUS_CANCELLED',
 				'value' => 'cancelled',
 				'url' => 'unzercw_ideal___status_cancelled:order_status',
 				'de' => array(
 			...
 			'UNZERCW_IDEAL_STATUS_CAPTURED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_IDEAL_STATUS_CAPTURED',
 				'value' => 'no_status_change',
 				'url' => 'unzercw_ideal___status_captured:order_status',
 				'de' => array(
 			...
 			'UNZERCW_IDEAL_PLACEHOLDER_SIZE' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_IDEAL_PLACEHOLDER_SIZE',
 				'value' => 'narrow',
 				'url' => 'unzercw_ideal___placeholder_size',
 				'de' => array(
 			...
 			'UNZERCW_IDEAL_SEND_BASKET' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_IDEAL_SEND_BASKET',
 				'value' => 'no',
 				'url' => 'unzercw_ideal___send_basket',
 				'de' => array(
 			...
 			'UNZERCW_IDEAL_SEND_CUSTOMER' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_IDEAL_SEND_CUSTOMER',
 				'value' => 'no',
 				'url' => 'unzercw_ideal___send_customer',
 				'de' => array(
 			...
 			'UNZERCW_IDEAL_AUTHORIZATIONMETHOD' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_IDEAL_AUTHORIZATIONMETHOD',
 				'value' => 'AjaxAuthorization',
 				'url' => 'unzercw_ideal___authorizationmethod',
 				'de' => array(
 			...
 			'UNZERCW_IDEAL_ALLOW_ALIAS_OPT_OUT' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_IDEAL_ALLOW_ALIAS_OPT_OUT',
 				'value' => 'yes',
 				'url' => 'unzercw_ideal___allow_alias_opt_out',
 				'de' => array(
 			...
 			'UNZERCW_IDEAL_PAYMENT_FORM_POSITION' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_IDEAL_PAYMENT_FORM_POSITION',
 				'value' => 'confirmation_page',
 				'url' => 'unzercw_ideal___payment_form_position',
 				'de' => array(
