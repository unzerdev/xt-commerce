...
class cw_UNZ_eps extends UnzerCw_AbstractPaymentMethod
{
	private $paymentMethodName = 'eps';
	private $defaultDisplayName = 'EPS';
	private static $settingsDefintions = array(
		'status_authorized' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_EPS_STATUS_AUTHORIZED',
 			'default' => 'authorized',
 		),
 		'status_uncertain' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_EPS_STATUS_UNCERTAIN',
 			'default' => 'uncertain',
 		),
 		'status_cancelled' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_EPS_STATUS_CANCELLED',
 			'options' => array(
 		...
 		'status_captured' => array(
			'type' => 'ORDERSTATUSSELECT',
 			'constant' => 'UNZERCW_EPS_STATUS_CAPTURED',
 			'options' => array(
				'no_status_change' => 'Don\'t change order status',
 			),
 		...
 		'send_basket' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_EPS_SEND_BASKET',
 			'options' => array(
				'no' => 'Do not send',
 				'yes' => 'Send Basket',
 			),
 		...
 		'send_customer' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_EPS_SEND_CUSTOMER',
 			'options' => array(
				'no' => 'Do not send',
 				'yes' => 'Send Customer',
 			),
 		...
 		'authorizationmethod' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_EPS_AUTHORIZATIONMETHOD',
 			'options' => array(
 		...
 		'allow_alias_opt_out' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_EPS_ALLOW_ALIAS_OPT_OUT',
 			'options' => array(
				'yes' => 'Yes',
 				'no' => 'No',
 			),
 		...
 		'payment_form_position' => array(
			'type' => 'SELECT',
 			'constant' => 'UNZERCW_EPS_PAYMENT_FORM_POSITION',
 			'options' => array(
	...
	private static $installSettings = array(
			'UNZERCW_EPS_STATUS_AUTHORIZED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_EPS_STATUS_AUTHORIZED',
 				'value' => 'authorized',
 				'url' => 'unzercw_eps___status_authorized:order_status',
 				'de' => array(
 			...
 			'UNZERCW_EPS_STATUS_UNCERTAIN' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_EPS_STATUS_UNCERTAIN',
 				'value' => 'uncertain',
 				'url' => 'unzercw_eps___status_uncertain:order_status',
 				'de' => array(
 			...
 			'UNZERCW_EPS_STATUS_CANCELLED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_EPS_STATUS_CANCELLED',
 				'value' => 'cancelled',
 				'url' => 'unzercw_eps___status_cancelled:order_status',
 				'de' => array(
 			...
 			'UNZERCW_EPS_STATUS_CAPTURED' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_EPS_STATUS_CAPTURED',
 				'value' => 'no_status_change',
 				'url' => 'unzercw_eps___status_captured:order_status',
 				'de' => array(
 			...
 			'UNZERCW_EPS_SEND_BASKET' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_EPS_SEND_BASKET',
 				'value' => 'no',
 				'url' => 'unzercw_eps___send_basket',
 				'de' => array(
 			...
 			'UNZERCW_EPS_SEND_CUSTOMER' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_EPS_SEND_CUSTOMER',
 				'value' => 'no',
 				'url' => 'unzercw_eps___send_customer',
 				'de' => array(
 			...
 			'UNZERCW_EPS_AUTHORIZATIONMETHOD' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_EPS_AUTHORIZATIONMETHOD',
 				'value' => 'AjaxAuthorization',
 				'url' => 'unzercw_eps___authorizationmethod',
 				'de' => array(
 			...
 			'UNZERCW_EPS_ALLOW_ALIAS_OPT_OUT' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_EPS_ALLOW_ALIAS_OPT_OUT',
 				'value' => 'yes',
 				'url' => 'unzercw_eps___allow_alias_opt_out',
 				'de' => array(
 			...
 			'UNZERCW_EPS_PAYMENT_FORM_POSITION' => array(
				'type' => 'dropdown',
 				'key' => 'UNZERCW_EPS_PAYMENT_FORM_POSITION',
 				'value' => 'confirmation_page',
 				'url' => 'unzercw_eps___payment_form_position',
 				'de' => array(
