...
<body>
	<div class="col-md-12">
		...
		<p><?php echo UnzerCw_Language::_('The transaction was successful.'); ?></p>
		
		<button onclick="window.opener.current_window.close(); window.opener.contentTabs.getActiveTab().getUpdater().refresh(); self.close();" class="btn btn-success">
